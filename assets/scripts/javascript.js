function requiredTrophies() {
  return fetch("https://api.brawlapi.com/v1/clublog/2R8QP0C9C")
    .then((resp) => resp.json())
    .then((data) => (document.getElementById("requiredTrophies").innerHTML = 'A <span class="font-bold">minimum</span> of <span class="font-bold">' + data.club.requiredTrophies + "</span> trophies."));
}
